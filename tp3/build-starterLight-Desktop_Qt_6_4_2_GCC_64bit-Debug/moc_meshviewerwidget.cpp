...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_MeshViewerWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_MeshViewerWidget_t qt_meta_stringdata_MeshViewerWidget = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_MeshViewerWidget[] = {
...
Q_CONSTINIT const QMetaObject MeshViewerWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_MeshViewerWidget.offsetsAndSizes,
    qt_meta_data_MeshViewerWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_MeshViewerWidget_t,
        // Q_OBJECT / Q_GADGET
